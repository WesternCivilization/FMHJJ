...
namespace FMHJJService.Common
{
    public static class Utils
    {
        ...
        {            
            if (HttpContext.Current != null)
            {
                if (HttpContext.Current.Request.Cookies[System.Web.Security.FormsAuthentication.FormsCookieName] != null) HttpContext.Current.Request.Cookies.Remove(System.Web.Security.FormsAuthentication.FormsCookieName);
