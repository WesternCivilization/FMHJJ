...
using System.Web;
using System.Xml;
using FMHJJService.CacheService;
using FMHJJService.Common;
using FMHJJService.Common.Enum;


namespace FMHJJService.Business
{
    public class SMSBusiness
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool SendSMSNotice(string templateID, string mobile, string message, out string errMsg)
        {
            errMsg = string.Empty;
            ...
            string body = string.Format(templateContent, message) + (userSuffix == true ? suffix : "");
            Send("0", mobile, body);
            return true;
        }
